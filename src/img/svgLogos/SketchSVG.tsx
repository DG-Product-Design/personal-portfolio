...
const SketchSVG = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394 356">
			<g fill="none">
				...
				<g transform="translate(0 126.881084)">
					<path fill="#EA6C00" d="m79.634 0 116.969 228.942L0 0z"/>
					<path fill="#EA6C00" d="m313.571468 0-116.969 228.942L393.205468 0z"/>
					<path fill="#FDAD00" d="M79.634 0h233.938L196.603 228.942z"/>
				</g>
